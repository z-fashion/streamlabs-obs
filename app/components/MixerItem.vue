  ...
  <div class="mixer-item" :class="{ muted: props.audioSource.muted }">
    <div class="flex">
      ...
      <div class="db-value">
        ...
        <div v-if="props.audioSource.fader.deflection !== 0">
          {{ props.audioSource.fader.db.toFixed(1) }} dB
        </div>
      </div>
    </div>
    ...
    <div class="flex">
      ...
      <div class="controls">
        ...
        <i class="icon-button icon-settings" @click="showSourceMenu(props.audioSource.sourceId)">
        </i>
      </div>
    </div>
  </div>
